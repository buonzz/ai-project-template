...
This file is automatically read by Claude Code and compatible AI coding assistants.
...
```
.
├── CLAUDE.md              # This file — agent context (Claude Code)
├── AGENT.md               # Agent context (Cursor, Windsurf, Copilot)
